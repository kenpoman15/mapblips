local blips = {
	...
	--{title="Fire Station 4", colour=49, id=436, x = 1185.46, y = -1462.02, z = 34.90},	-- Zancudo; U.S.A.F.
	{title="Fire Station 5", colour=49, id=436, x = -381.14, y = 6119.76, z = 31.48},	-- Paleto Bay
	--{title="Fire Station 6", colour=49, id=436, x = 1185.46, y = -1462.02, z = 34.90},	-- LSIA
